			...
			services: []*model.Service{
				{
					...
					Attributes: model.ServiceAttributes{
						Name:      "productpage",
						Namespace: "bookinfo",
						ExportTo:  sets.New[visibility.Instance](visibility.None),
					},
				},
			},
			expectedMessage: federationmodel.ServiceListMessage{},
			...
			services: []*model.Service{
				{
					...
					Attributes: model.ServiceAttributes{
						Name:      "productpage",
						Namespace: "bookinfo",
						ExportTo:  sets.New[visibility.Instance](visibility.Private),
					},
				},
			},
			expectedMessage: federationmodel.ServiceListMessage{},
			...
			services: []*model.Service{
				{
					...
					Attributes: model.ServiceAttributes{
						Name:      "productpage",
						Namespace: "bookinfo",
						ExportTo:  sets.New[visibility.Instance](visibility.Instance("foreign-namespace")),
					},
				},
			},
			expectedMessage: federationmodel.ServiceListMessage{},
			...
			services: []*model.Service{
				{
					...
					Attributes: model.ServiceAttributes{
						Name:      "productpage",
						Namespace: "bookinfo",
						ExportTo:  sets.New[visibility.Instance](visibility.Instance("istio-system-test")),
					},
				},
			},
			expectedMessage: federationmodel.ServiceListMessage{
